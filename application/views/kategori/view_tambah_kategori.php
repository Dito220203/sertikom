	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="d-flex align-items-center mb-3">
				...
				<h4 class="fw-bold m-0" style="color: var(--primary-emerald);">TAMBAH DATA KATEGORI</h4>
			</div>
				...
				<div class="card-body p-4">
					<form action="<?= base_url('kategori/simpan_kategori') ?>" method="POST" >
						...
						<div class="mb-3">
							...
							<input type="text" name="kategori" class="form-control border-success" placeholder="Nama kategori" required>
						</div>
